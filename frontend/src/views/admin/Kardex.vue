...
<template>
  <div class="crud-view">
    <div class="page-header">
      <h1 class="page-title text-primary">Módulo Kardex</h1>
      <p class="text-muted">Registro de movimientos de vehículos.</p>
    </div>
    <div style="display:flex; justify-content:flex-end; margin-bottom:2rem;">
      <button @click="openCreate" class="btn-primary" style="padding:0.75rem 2rem; display:flex; align-items:center; gap:0.5rem;">
        <span style="font-size:1.25rem;">+</span> Nuevo Movimiento
      </button>
    </div>
    <div class="glass-panel" style="padding:0; overflow:hidden;">
      ...
      <div v-else style="padding:4rem; text-align:center;"><h3 class="text-muted">La tabla está vacía</h3><button @click="openCreate" class="btn-primary" style="margin-top:2rem;">Crear primer registro</button></div>
    </div>
