export const swaggerSpec = {
  ...
  paths: {
    ...
    '/api/v1/mateodavid/vehiculos/{id}': {
      get: {
        tags: ['Vehículos'],
    ...
    '/api/v1/mateodavid/tipos-combustible': {
      get: {
        tags: ['Catálogos'],
    ...
    '/api/v1/mateodavid/tipos-transmision': {
      get: {
        tags: ['Catálogos'],
    ...
    // ── Booking Integration ─────────────────────────────────────────────────
    '/api/v1/mateodavid/vehiculos/booking': {
      get: {
    ...
    '/api/v1/mateodavid/vehiculos/booking/{id}': {
      get: {
        tags: ['Booking Integration'],
    ...
    '/api/v1/mateodavid/vehiculos/booking/{id}/disponibilidad': {
      get: {
        tags: ['Booking Integration'],
