export const swaggerSpec = {
  ...
  paths: {
    ...
    '/api/v1/mateodavid/reservas/{id}/cancel': {
      post: {
        tags: ['Reservas'],
    ...
    '/api/v1/mateodavid/alquileres/{id}': {
      get: {
        tags: ['Alquileres'],
    ...
    '/api/v1/mateodavid/alquileres/{id}/devolucion': {
      post: {
        tags: ['Alquileres'],
    ...
    '/api/v1/mateodavid/canales-venta': {
      get: {
        tags: ['Catálogos Ops'],
    ...
    // ── Booking Integration ─────────────────────────────────────────────────
    '/api/v1/mateodavid/reservas/booking': {
      post: {
    ...
    '/api/v1/mateodavid/reservas/booking/{id}': {
      get: {
        tags: ['Booking Integration'],
    ...
    '/api/v1/mateodavid/alquileres/booking': {
      post: {
        tags: ['Booking Integration'],
    ...
    '/api/v1/mateodavid/devoluciones/booking': {
      post: {
        tags: ['Booking Integration'],
