export const swaggerSpec = {
  ...
  paths: {
    '/api/v1/mateodavid/mantenimientos': {
      get: {
        tags: ['Mantenimientos'],
    ...
    '/api/v1/mateodavid/mantenimientos/{id}': {
      get: {
        tags: ['Mantenimientos'],
    ...
    '/api/v1/mateodavid/sistemas-externos': {
      get: {
    ...
    '/api/v1/mateodavid/sistemas-externos/{id}': {
      get: {
        tags: ['Sistemas Externos'],
