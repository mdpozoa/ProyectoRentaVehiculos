...
app.use('/api/v1/mateodavid/mantenimientos',    createMantenimientoRouter(mantenimientoController));
app.use('/api/v1/mateodavid/kardex',            createKardexRouter(kardexController));
