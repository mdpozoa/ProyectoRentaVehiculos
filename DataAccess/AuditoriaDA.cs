...
namespace ProyectoRentaVehiculos.DataAccess
{
    public class AuditoriaDA
    {
        ...
        public async Task<Siniestro?> CreateSiniestro(Siniestro e) { e.IdSiniestro = null; var r = await _supabase.From<Siniestro>().Insert(e); return r.Models.FirstOrDefault(); }
        ...
        public async Task<Auditoria?> CreateAuditoria(Auditoria e) { e.IdAuditoria = null; var r = await _supabase.From<Auditoria>().Insert(e); return r.Models.FirstOrDefault(); }
        ...
        public async Task<DetalleFactura?> CreateDetalle(DetalleFactura e) { e.IdDetalle = null; var r = await _supabase.From<DetalleFactura>().Insert(e); return r.Models.FirstOrDefault(); }
    }
}
